CREATE DATABASE IF NOT EXISTS `qbus`
USE `qbus`;
...
CREATE TABLE IF NOT EXISTS `dealers` (
  ...
  `coords` longtext CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  `time` longtext CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gloveboxitemsnew` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `plate` varchar(255) DEFAULT NULL,
  `items` longtext CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `plate` (`plate`)
...
CREATE TABLE IF NOT EXISTS `phone_messages` (
  ...
  KEY `citizenid` (`citizenid`),
  KEY `number` (`number`)
) ENGINE=InnoDB AUTO_INCREMENT=6732 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `phone_tweets` (
  ...
  PRIMARY KEY (`id`),
  KEY `citizenid` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=5436 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `player_contacts` (
  ...
  PRIMARY KEY (`id`),
  KEY `citizenid` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=12433 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `player_mails` (
  ...
  PRIMARY KEY (`id`),
  KEY `citizenid` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=67023 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=8970 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `player_vehicles` (
  ...
  `mods` longtext CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
